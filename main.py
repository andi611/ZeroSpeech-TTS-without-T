...
if __name__ == '__main__':
	...
	static_setting.add_argument('--enc_mode', choices=['continues', 'one_hot', 'binary', 'sparse_binary', 'gumbel_t', 'set_from_hps'], default='set_from_hps', help='different output method for the encoder to generate encodings')
