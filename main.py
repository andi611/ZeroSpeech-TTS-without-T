...
if __name__ == '__main__':
	...
	model_path.add_argument('--load_train_model_name', type=str, default='model.pth-ae-400000', help='the model to restore for training, the command --load_model will load this model')
